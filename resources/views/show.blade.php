        ...
        <div class="md:ml-24">
                ...
                <div class="mt-12">
                    ...
                    @if (count($movie['videos']['results']) > 0)
                        <div class="mt-12">
                        <a href='https://youtube.com/watch?v={{$movie['videos']['results'][1]['key']}}' class="flex inline-flex items-center rounded font-semibold text-gray-900 bg-orange-500 px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
